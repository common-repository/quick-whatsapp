...
* WhatsApp chat offline function
* 4 WhatsApp buttons are available to choose from
* Floating button
* You can now position the floating button anywhere with pixel accuracy
...
== Changelog ==
  ...
  * Add shortcode for up to 3 whatsapp groups
  = v3.4 (05/02/2024) =
  * Add Multi Language (German / Swissgerman / English)
  = v3.3.7 (03/18/2023) =
  * Debug
  = v3.3.6 (06/05/2022) =
